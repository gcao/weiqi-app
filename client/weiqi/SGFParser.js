			...
			do {
				...
				case STATE_NODE:
					...
					if (isRoot) {
						...
						// Create empty node
						var newNode = new models.Node(currentNode);
						...
						do {
							...
							if (input.charAt(pos + 1) == ']') {
								...
								if (prop == PROPERTY_MOVE_BLACK || prop == PROPERTY_MOVE_WHITE) {
									currentNode.type = models.NODE_PASS;
							...
							case PROPERTY_MOVE_WHITE:
								...
								currentNode.type = models.NODE_MOVE;
								if (x >= 19 || y >= 19)
									currentNode.type = models.NODE_PASS;
							...
							case PROPERTY_EDIT_ERASE:
								x = input.charCodeAt(pos + 1) - CHAR_A_CODE;
								y = input.charCodeAt(pos + 2) - CHAR_A_CODE;
								currentNode.points.push(new models.Point(x, y, color));
